Rails.application.routes.draw do
  ...
  scope "/:locale", locale: /#{I18n.available_locales.join('|')}/ do
    ...
    scope "articles" do
      ...
      scope "top-areas" do
        get "/", to: redirect("/%{locale}/blocs")
        get "level", to: redirect("/%{locale}/blocs"), as: :legacy_top_areas_level # keep until end of 2023
        get "groups", to: redirect("/%{locale}/blocs"), as: :legacy_top_areas_groups # keep until end of 2023
    ...
    scope "blocs" do
      ...
      get "/areas", to: redirect("/%{locale}/blocs"), as: :areas_legacy # keep until ??
